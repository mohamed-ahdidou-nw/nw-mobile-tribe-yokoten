...
import { CharacterModel, type CharacterSnapshotOut } from "../character/character";
...
export type CharacterStore = Record<string, unknown> & Instance<typeof CharacterStoreModel>
export type CharacterStoreSnapshotOut = Record<string, unknown> & SnapshotOut<typeof CharacterStoreModel>
export type CharacterStoreSnapshotIn = Record<string, unknown> & SnapshotIn<typeof CharacterStoreModel>
