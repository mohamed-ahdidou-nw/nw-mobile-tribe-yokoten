...
export type CharacterStoreSnapshotOut = Record<string, unknown> &
  SnapshotOut<typeof CharacterStoreModel>
export type CharacterStoreSnapshotIn = Record<string, unknown> &
  SnapshotIn<typeof CharacterStoreModel>
